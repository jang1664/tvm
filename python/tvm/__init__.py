...
from .runtime._tensor import vpi, rocm, ext_dev, vortex, hexagon
...
# Side-effect imports: register device compiler FFI callbacks at TVM startup
from .support import rocm as _rocm, nvcc as _nvcc, vortex as _vortex
